...
const DashboardGrid = () => {
  const modules = [
    ...
    { label: "Employee", image: "/images/employees.png", path: "employee" },
    ...
    { label: "HR Documents", image: "/images/hr-document.png", path: "hrDocuments" },
    { label: "Recruitment", image: "/images/recruitment.png", path: "recruitment" },
    { label: "Calendar", image: "/images/calendar.png", path: "calendar" },
    { label: "Performance", image: "/images/performance.png", path: "performance" },
    { label: "Logit", image: "/images/parcel.png", path: "logit" },
    { label: "Evolve", image: "/images/evolution.png", path: "evolve" },
    { label: "EPFO Website", image: "/images/epfo.png", path: "epfoWebite" },
    { label: "Policies", image: "/images/privacy-policy.png", path: "policies" },
    { label: "P2P", image: "/images/p2p.png", path: "p2p" },
    { label: "Happay", image: "/images/happay.png", path: "happay" },
    { label: "Blue Box", image: "/images/blue-box.png", path: "bluebox" },
